                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span>subtotal:</span> <span><?php echo $sub ?></span></li>
                                <li><span>delivery:</span> <span><?php echo $_SESSION['del'] ?></span></li>
                            ...
                            <div class="cart-btn mt-100">
                                <a href="email.php?checkout=true" class="btn amado-btn w-100">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
